...
Source for <https://themedocs.github.io/simple-elegant/> — the documentation for the Simple & Elegant WordPress theme.
...
```
content/index.md          the simple-elegant docs home
content/<section>/<page>.md
docs/assets/              screenshots, referenced as /simple-elegant/assets/…
